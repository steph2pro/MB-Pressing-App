...
<?php 
	...
	if (($requetes!=null) && (sizeof($requetes)>0)):
		...
		foreach ($requetes as $requete):
			...
			$update='modifier_facture2.php?id_facturation='.$requete->id_facturation;

			$imprimer='imprimer2.php?id_facturation='.$requete->id_facturation;			//$delete='delete.php?id_request='.$requete->id_request;
				...
				<tbody>
					<tr class="element">
						...
						<td class="options" style="height:100px;">
							<a href="<?= $update ?>" class="update" style="position: absolute; margin:-2vw -2.6vw">modifier</a>
							<br>
							<a href="<?= $imprimer ?>" class="imprimer" style="position: absolute; margin:0.2vw -2.6vw">imprimer</a>
